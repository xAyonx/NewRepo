...
function displayGlitts(glitts) {
    glitts.map(function(glitt) {
        ...
        return document.getElementById("gl-card-container").innerHTML += glitt;
    });
}
/**
...
function postGlittToBackend(glittName, glittText) {
    ...
    fetch("http://localhost:4000/glitts", fetchConfig).then(function(res) {
        res.status;
        resetForm();
...
//# sourceMappingURL=index.ab135151.js.map
